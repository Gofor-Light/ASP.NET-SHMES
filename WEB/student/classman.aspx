<%@ Page Language="C#" MasterPageFile="~/student.master" AutoEventWireup="true" CodeFile="classman.aspx.cs"
    Inherits="student_classman" Title="课程页" %>
    ...
    <div class="gr1">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <Columns>
                ...
                <asp:HyperLinkField HeaderText="查看详情" DataNavigateUrlFields="classId,className,term,teacherName"
                    DataNavigateUrlFormatString="viewclass.aspx?classId={0}&amp;classname={1}&amp;term={2}&amp;teacherName={3}"
                    DataTextField="classId" DataTextFormatString="查看课程成员">
