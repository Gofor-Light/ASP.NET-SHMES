<%@ Page Language="C#" MasterPageFile="~/student.master" AutoEventWireup="true" CodeFile="viewhomework.aspx.cs" Inherits="student_viewhomework" Title="查看作业页" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <span>作业名</span><asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
    </div>
    <div>
