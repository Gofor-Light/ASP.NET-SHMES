<%@ Page Language="C#" MasterPageFile="~/teacher.master" AutoEventWireup="true" CodeFile="countbytimesbystu.aspx.cs"
    Inherits="teacher_countbytimesbystu" Title="统计作业页" %>
            ...
            <div class="gr1">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="是否已评">
                            <ItemTemplate>
