...
public partial class teacher_stuhomeworklistbytime : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName=="reviews")
        {
            ...
            TextBox2.Text = GridView1.DataKeys[row.RowIndex].Values[2].ToString();
