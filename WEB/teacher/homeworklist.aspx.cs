...
public partial class teacher_homeworklist : System.Web.UI.Page
{
    ...
    {
        HomeworkListManage cm = new HomeworkListManage();
        GridView1.DataSource = cm.SelectByClass(Convert.ToInt32(Request.QueryString["classId"]));
        GridView1.DataBind();
    }
}
