...
public partial class teacher_countbytimesbystu : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["teacherId"] != null)
        {
            if (!IsPostBack)
            {
                ...
                DropDownList2.DataSource = sm.SelectAllstu(Convert.ToInt32(Request.QueryString["classId"]));
                DropDownList2.DataTextField = "studentId";
    ...
    public void gridviewBind()
    {
        ...
        n.StudentId = DropDownList2.SelectedItem.Text; 
        n.ClassId=Convert.ToInt32(Label6.Text);
        n.Times=DropDownList1.SelectedIndex+1;
        DataTable dt = sm.SelectAllByTimesByStu(n);
