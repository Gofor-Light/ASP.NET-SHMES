<%@ Page Language="C#" MasterPageFile="~/teacher.master" AutoEventWireup="true" CodeFile="settinghomework.aspx.cs"
    Inherits="teacher_settinghomework" Title="作业页" %>
    ...
    <div class="gr1">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="classId,classname,term,name"
                    DataNavigateUrlFormatString="addhomework.aspx?classId={0}&amp;classname={1}&amp;term={2}&amp;name={3}"
                    DataTextField="classId" DataTextFormatString="布置作业">
                    <ItemStyle Font-Size="12px" />
                </asp:HyperLinkField>
                <asp:HyperLinkField Text="作业列表" 
                    DataNavigateUrlFields="classId,classname,term,name" 
                    DataNavigateUrlFormatString="homeworklist.aspx?classId={0}&amp;classname={1}&amp;term={2}&amp;name={3}" />
            </Columns>
            <PagerTemplate>
