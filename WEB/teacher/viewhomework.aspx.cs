...
public partial class teacher_viewhomework : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("edithomework.aspx?times=" + Label1.Text + "&name=" + Label2.Text + "&remarks=" + txt2.Text + "&publishTime=" + Label3.Text + "&closeTime=" + Label4.Text + "&classId=" + Label6.Text + "&classname=" + Label7.Text + "&term=" + Label8.Text + "&content=" + HyperLink1.NavigateUrl);
    }
}
