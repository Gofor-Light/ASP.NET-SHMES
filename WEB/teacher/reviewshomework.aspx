<%@ Page Language="C#" MasterPageFile="~/teacher.master" AutoEventWireup="true" CodeFile="reviewshomework.aspx.cs"
    Inherits="teacher_reviewshomework" Title="批阅作业页" %>
    ...
    <div class="gr1">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <Columns>
                ...
                <asp:HyperLinkField Text="批阅" DataNavigateUrlFields="classId,classname,term"
                    DataNavigateUrlFormatString="reviewshomeworkbyclass.aspx?classId={0}&amp;classname={1}&amp;term={2}&amp" />
            </Columns>
            <PagerTemplate>
