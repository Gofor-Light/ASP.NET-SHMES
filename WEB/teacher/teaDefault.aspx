<%@ Page Language="C#" MasterPageFile="~/teacher.master" AutoEventWireup="true" CodeFile="teaDefault.aspx.cs"
    Inherits="teacher_teaDefault" Title="教师首页" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        ...
        <span>职称</span><asp:Label ID="Label2" runat="server" Text="Label" CssClass="lbl"></asp:Label>
    </div>
    <div>
