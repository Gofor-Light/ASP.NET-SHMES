<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="classman.aspx.cs"
    Inherits="admin_classman" Title="课程管理页" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="search">
        <div class="sc ">
            <span>查询</span><asp:TextBox ID="txtSea" runat="server" Width="100px" 
                ToolTip="课程名称或教师ID或老师名字"></asp:TextBox>
        </div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="任课老师">
                    <ItemTemplate>
                        <asp:Label ID="Label3" runat="server" Text='<%# Eval("name") %>' Width="65px"></asp:Label>
                    </ItemTemplate>
                    <ItemStyle />
                </asp:TemplateField>
                <asp:HyperLinkField HeaderText="查看详情" DataNavigateUrlFields="classId,classname,term,name"
                    ...
                    DataTextField="classId" DataTextFormatString="查看或编辑班级成员">
