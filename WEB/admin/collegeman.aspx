<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="collegeman.aspx.cs"
    Inherits="admin_collegeman" Title="学院管理页" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="gr1">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
            ...
            DataKeyNames="college" OnRowDeleting="GridView1_RowDeleting">
            <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
            <RowStyle BackColor="#EFF3FB" />
            <Columns>
                <asp:TemplateField HeaderText="学院">
                    <ItemTemplate>
                        <asp:Label ID="Label14" runat="server" Text='<%# Eval("college") %>' Width="120px"></asp:Label>
                    </ItemTemplate>
                    <ItemStyle Height="30px" />
                </asp:TemplateField>
                <asp:TemplateField ShowHeader="False">
                    <ItemTemplate>
                        <asp:Button ID="Button2" CssClass="btn" runat="server" CommandName="delete" Text="删除"
    ...
    <div>
        <span>名称</span><asp:TextBox ID="TextBox1" runat="server" CssClass="txt"></asp:TextBox>
        <div>
            <asp:Button ID="Button1" runat="server" Text="新增" CssClass="bt1" OnClick="Button1_Click" />
        </div>
    </div>
</asp:Content>
