...
namespace BLL
{
    public class StuHomeworkManage
    {
        ...
        /// <returns></returns>
        public void Insert(stuHomework n)
        {
            ndao.Insert(n);
            ndao.InsertMut_Eval_List(n);
        }
        #endregion
        ...
        {
            return ndao.SelectAllByTimesByStu(n);
        }
        #endregion
